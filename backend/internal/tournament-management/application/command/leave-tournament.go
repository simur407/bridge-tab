...
type LeaveTournamentCommand struct {
	TournamentId   string
	ContestantId 	string
}

// Execute executes the command
func (c *LeaveTournamentCommand) Execute(repo domain.TournamentRepository) error {
	...
	if err := t.LeaveTournament(&contestantId); err != nil {
		return err
	}
